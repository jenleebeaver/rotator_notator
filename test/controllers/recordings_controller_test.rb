...
class RecordingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recording" do
    assert_difference('Recording.count') do
      post recordings_url, params: { recording: { melody: @recording.melody, title: @recording.title } }
    end
  ...
  test "should update recording" do
    patch recording_url(@recording), params: { recording: { melody: @recording.melody, title: @recording.title } }
